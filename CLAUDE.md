...
| `wishes` | nickName(提出者), title, description, images (cloud fileIDs), points (Number\|null；null=未定价，编辑保存后清空需重新定价), status (`open`/`redeemed`), createTime — 心愿单 |
